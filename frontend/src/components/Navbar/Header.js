...
import { AppBar, Box, Toolbar, Typography, InputBase, Avatar, Button, Modal, TextField } from '@mui/material';
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static">
                <Toolbar>
                    <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1, display: { xs: 'none', sm: 'block' } }} >Streameo</Typography>
                    {isLoggedIn &&
                        <>
                            <Search>
